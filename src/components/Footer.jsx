const Footer = () => {
  return (
    <footer className="bg-tech-dark border-t border-tech-blue/20 mt-auto">
      {/* Contact Us */}
      <section id="contact" className="bg-tech-darker/50 border-t border-tech-blue/20 py-6 md:py-8">
        <div className="tech-container text-center">
          <h2 className="tech-subheading mb-4 text-lg md:text-xl">Contact Us</h2>
          <div className="flex justify-center gap-6">
            <a
              href="https://www.instagram.com/ctrl_sdsu/"
              target="_blank"
              rel="noopener noreferrer"
              className="flex flex-col items-center gap-1.5 text-tech-blue hover:text-tech-purple transition-colors duration-200"
            >
      ...
      <div className="tech-container py-5">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-3 md:mb-0">
            <h3 className="text-lg font-bold bg-gradient-to-r from-tech-blue to-tech-purple bg-clip-text text-transparent mb-1">
              [<span className="italic font-normal">ctrl</span>]
            </h3>
          ...
          <div className="text-center md:text-right">
            <p className="text-gray-400 text-xs">
              © {new Date().getFullYear()} [<span className="italic">ctrl</span>]. All rights reserved.
            </p>
